...
- [API Reference](./API.md) - API documentation for all modules
- [User Guide](./USER_GUIDE.md) - How to use the audit system
...
1. [Getting Started](./USER_GUIDE.md#getting-started)
2. [Architecture Overview](./ARCHITECTURE.md)
3. [Auditor Modules](./API.md#auditor-modules)
